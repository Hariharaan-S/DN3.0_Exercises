...
public class BookController {
    ...
    @PostMapping(value = "/add/book", consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    @ResponseStatus(HttpStatus.CREATED)
    public BookDTO createBook(@RequestBody Book newBook) {
        return bookService.convertToBookDto(bookService.saveBook(newBook));
    }

    @GetMapping(value = "/get/books", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
